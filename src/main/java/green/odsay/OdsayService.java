...
import green.odsay.model.PubTransPathGetReq;
import green.odsay.model.PubTransPathVo;
...
public class OdsayService {
    private final green.odsay.config.constant.OdsayApiConst odsayApiConst;
